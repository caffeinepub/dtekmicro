...
export class Backend implements backendInterface {
    ...
    async addJob(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addJob(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addTestimonial(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitApplication(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
